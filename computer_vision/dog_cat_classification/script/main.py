...
images = [
    DogCatClassification("data/cat1.jpeg",1),
    DogCatClassification("data/cat2.jpeg",1),
    DogCatClassification("data/cat3.jpeg",1),
    DogCatClassification("data/cat4.jpeg",1),
    DogCatClassification("data/dog1.jpeg",0),
    DogCatClassification("data/dog2.jpeg",0),
    DogCatClassification("data/dog3.jpeg",0),
    DogCatClassification("data/dog4.jpeg",0),
